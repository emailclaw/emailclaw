---
name: file_reader
description: "Read and summarize text-based file types only. Prefer read_file for text formats; use execute for type detection when needed. PDF/Office/images/archives are handled by other skills."
metadata:
